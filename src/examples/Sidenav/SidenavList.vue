<template>
  <div class="collapse navbar-collapse w-auto h-auto h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <!-- //////////////////////// -->
      <li class="nav-item">
        <sidenav-item url="/test" :class="getRoute() === 'test' ? 'active' : ''" navText="Test">
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item url="/template-test" :class="getRoute() === 'template-test' ? 'active' : ''" navText="TemplateTest">
          <template v-slot:icon>
            <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      ...
      <li class="nav-item">
        <sidenav-item url="/test-emit" :class="getRoute() === 'test-emit' ? 'active' : ''" navText="testEmit">
          <template v-slot:icon>
            <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      ...
      <li class="nav-item">
        <sidenav-item url="/test-async-define" :class="getRoute() === 'test-async-define' ? 'active' : ''"
          navText="test-async-define">
          <template v-slot:icon>
            <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      ...
      <li class="nav-item">
        <sidenav-item url="/test-props" :class="getRoute() === 'test-props' ? 'active' : ''" navText="testProps">
          <template v-slot:icon>
            <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
          </template>
        </sidenav-item>
